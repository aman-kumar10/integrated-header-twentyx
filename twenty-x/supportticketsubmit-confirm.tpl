<div class="card">
    <div class="card-body extra-padding">
        ...
        <br />
    <p class="text-center">
             <a href="{$WEB_ROOT}/index.php?m=secureticketdata&tid={$tid}" class="btn btn-primary">
                Submit Secure Credential
            </a>
            <br/>
            <small>Submit your confidential information securly to resolve this ticket asap.</small>
        </p>
        <br />
