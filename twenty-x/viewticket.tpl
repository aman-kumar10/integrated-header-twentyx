                ...
                <div class="form-group">
                    ...
                    <div class="ips">
                        <div class="alert alert-warning" style="padding: 7px 15px; font-size: 0.9em;">
                            <b>Note:</b> Do not enter your confidential information (like admin login/FTP/cPanel/etc) in the message. WGS will not be responsible for security of confidential data provided in the message. At the top of this page you can see a button "Submit Secure Credential" to update securly.
                        </div>
                    </div>
                </div>
